...
@Component({
  selector: 'gts-fe-teacher-teaching-subject',
  templateUrl: './teacher-teaching-subject.component.html',
  styleUrls: ['./teacher-teaching-subject.component.scss']
})
export class TeacherTeachingSubjectComponent implements OnInit {
