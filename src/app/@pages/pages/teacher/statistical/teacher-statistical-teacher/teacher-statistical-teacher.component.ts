...
@Component({
  selector: 'gts-fe-teacher-statistical-teacher',
  templateUrl: './teacher-statistical-teacher.component.html',
  styleUrls: ['./teacher-statistical-teacher.component.scss']
})
export class TeacherStatisticalTeacherComponent implements OnInit {
