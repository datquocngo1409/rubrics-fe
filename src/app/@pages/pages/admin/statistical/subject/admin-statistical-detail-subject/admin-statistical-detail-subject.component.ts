...
@Component({
  selector: 'gts-fe-admin-statistical-detail-subject',
  templateUrl: './admin-statistical-detail-subject.component.html',
  styleUrls: ['./admin-statistical-detail-subject.component.scss']
})
export class AdminStatisticalDetailSubjectComponent implements OnInit {
