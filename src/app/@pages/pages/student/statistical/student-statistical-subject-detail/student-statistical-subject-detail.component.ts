...
@Component({
  selector: 'gts-fe-student-statistical-subject-detail',
  templateUrl: './student-statistical-subject-detail.component.html',
  styleUrls: ['./student-statistical-subject-detail.component.scss']
})
export class StudentStatisticalSubjectDetailComponent implements OnInit {
