...
@Component({
  selector: 'gts-fe-student-notyet-subject',
  templateUrl: './student-notyet-subject.component.html',
  styleUrls: ['./student-notyet-subject.component.scss']
})
export class StudentNotyetSubjectComponent implements OnInit {
